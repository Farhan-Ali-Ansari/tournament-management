/** Run once in Supabase → SQL Editor (existing projects only). */
export const CUSTOM_MODES_MIGRATION_SQL = `-- Allow custom_league and custom_knockout tournament modes
DO $$
DECLARE
  r RECORD;
BEGIN
